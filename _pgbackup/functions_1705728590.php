...
if ( ! function_exists( 'aussie_audio_theme_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'aussie_audio_theme-popper', get_template_directory_uri() . '/assets/js/popper.min.js', [], '1.0.4', true);

    wp_deregister_script( 'aussie_audio_theme-bootstrap' );
    wp_enqueue_script( 'aussie_audio_theme-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', [], '1.0.4', true);
    ...
    wp_enqueue_style( 'aussie_audio_theme-blocks', get_template_directory_uri() . '/blocks.css', [], '1.0.4', 'all');

    wp_deregister_style( 'aussie_audio_theme-bootstrap' );
    wp_enqueue_style( 'aussie_audio_theme-bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css', [], '1.0.4', 'all');

    wp_deregister_style( 'aussie_audio_theme-bootstrap-1' );
    wp_enqueue_style( 'aussie_audio_theme-bootstrap-1', get_template_directory_uri() . '/bootstrap_theme/bootstrap.css', [], '1.0.4', 'all');

    wp_deregister_style( 'aussie_audio_theme-style' );
    wp_enqueue_style( 'aussie_audio_theme-style', get_bloginfo('stylesheet_url'), [], '1.0.4', 'all');

...
<nav class="bg-primary navbar navbar-expand-lg navbar-light pb-3 pb-lg-1 pt-3 pt-lg-4"> 
    <div class="align-items-center d-flex flex-wrap justify-content-around pt-4 w-100"> 
        ...
        <a href="https://www.aussieaudio.com" class="col-lg-4 d-flex justify-content-center "><div class="header-logo">
                <img src="<?php echo get_template_directory_uri(); ?>/img/4%20Clear.png" class="img-fluid">
            </div></a> 
        <div class="col-lg-3 d-flex header-hide justify-content-center">
            <a href="consultation.html"><button type="button" class="btn btn-light btn-outline-primary btn-sm pb-2 pe-3 ps-3 pt-2 text-nowrap">
                    <?php _e( 'Schedule a Meeting', 'aussie_audio_theme' ); ?>
                </button></a>
        </div>
        <button class="bg-primary-subtle navbar-toggle-position navbar-toggler position-absolute" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown-6" aria-controls="navbarNavDropdown-6" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse  pt-lg-3 w-100" id="navbarNavDropdown-6"> 
            <ul class="align-items-end d-flex me-auto ms-auto navbar-nav pe-3 pe-lg-0"> 
                <li class="nav-item"> <a class="nav-item nav-link px-lg-3 py-lg-4 text-light" aria-current="page" href="index.html"><?php _e( 'Home', 'aussie_audio_theme' ); ?></a> 
                </li>                         
                <li class="nav-item"> <a class="active nav-item nav-link px-lg-3 py-lg-4 text-light" href="services.html"><?php _e( 'Services', 'aussie_audio_theme' ); ?></a> 
                </li>                         
    ...
    <div class="container"> 
        <div class="row"> 
            <div class="col-lg-6 col-md-9 col-xl-4 order-first order-md-first py-3"> <a href="#" class="d-inline-block h2 mb-4 text-decoration-none text-uppercase"><?php _e( 'Aussie Audio and Web Design', 'aussie_audio_theme' ); ?></a> 
                <p class="mb-3"><?php _e( 'HONORING CHRIST WITH', 'aussie_audio_theme' ); ?><?php _e( 'UPFRONT, HONEST WORK AND PRICING', 'aussie_audio_theme' ); ?></p> 
            ...
            <div class="col-lg-3 col-md-6 col-xl-2 order-3 order-lg-0 order-md-2 py-3"> 
                <h2 class="fw-bold h5 mb-4 text-uppercase text-white"><?php _e( 'Our Process and Reviews', 'aussie_audio_theme' ); ?></h2> 
                <ul class="list-unstyled"> 
                    <li class="mb-3"> <a href="#" class="text-white"><?php _e( 'Our Process', 'aussie_audio_theme' ); ?></a> 
                    </li>                             
                    <li class="mb-3"> <a href="#" class="text-white"><?php _e( 'Website Reviews', 'aussie_audio_theme' ); ?></a> 
                    </li>                             
                    <li class="mb-3"> <a href="#" class="text-white"><?php _e( 'Podcast Reviews', 'aussie_audio_theme' ); ?></a> 
                    </li>                             
                </ul>                         
            </div>                     
            <div class="col-lg-3 col-md-5 col-xl-2 order-4 order-lg-1 py-3"> 
                <h2 class="fw-bold h5 mb-4 text-uppercase text-white"><?php _e( 'Services', 'aussie_audio_theme' ); ?></h2> 
                <ul class="list-unstyled"> 
                    <li class="mb-3"> <a href="#" class="text-white"><?php _e( 'Web Services', 'aussie_audio_theme' ); ?></a> 
                    </li>                             
                    <li class="mb-3"> <a href="#" class="text-white"><?php _e( 'Audio Services', 'aussie_audio_theme' ); ?></a> 
                    </li>                             
                </ul>                         
            </div>
            <div class="col-md-12 col-xl-8 order-1 order-lg-3 order-md-1 py-3"> 
                <h2 class="fw-bold h5 mb-4 text-uppercase text-white"><?php _e( 'Schedule a Consultation', 'aussie_audio_theme' ); ?></h2>
                <p class="mb-3"><?php _e( 'As always, Our consultations are 100% free. We&apos;ll find out what your project is, how we can help you, and what the best options and pricing strategy is!', 'aussie_audio_theme' ); ?></p>
                <button type="button" class="btn btn-info btn-lg btn-outline-primary text-white">
                    <?php _e( 'Schedule', 'aussie_audio_theme' ); ?>
                </button>                         
            </div>
            <div class="col-md-3 order-0 order-lg-2 order-md-0">
                <h2 class="fw-bold h5 mb-3 text-uppercase text-white"><?php _e( 'Get Social', 'aussie_audio_theme' ); ?></h2>
                <div class="d-inline-flex flex-wrap"> <a href="#" class="p-1 text-secondary" aria-label="facebook"> <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" class="footer-social text-info"> 
                            <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/> 
                        </svg> </a> <a href="#" class="p-1 text-secondary" aria-label="twitter"> <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" class="footer-social text-info"> 
                            <path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z"/> 
                        </svg> </a> <a href="#" class="p-1 text-secondary" aria-label="instagram"> <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" class="footer-social text-info"> 
                        ...
                        </svg> </a> <a href="#" class="p-1 text-secondary" aria-label="linkedin"> <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" class="footer-social text-info"> 
                            <path d="M6.94 5a2 2 0 1 1-4-.002 2 2 0 0 1 4 .002zM7 8.48H3V21h4V8.48zm6.32 0H9.34V21h3.94v-6.57c0-3.66 4.77-4 4.77 0V21H22v-7.93c0-6.17-7.06-5.94-8.72-2.91l.04-1.68z"/> 
                        </svg> </a> <a href="#" class="p-1 text-secondary" aria-label="youtube"> <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" class="footer-social text-info"> 
        ...
        <div class="pb-3 pt-3 small"> 
            ...
            <div class="align-items-center row">
                <div class="col-md pb-2 pt-2">
                    <p class="mb-0"><?php _e( '&copy; 2002 - 2020. All Rights Reserved - Company Name', 'aussie_audio_theme' ); ?></p>
                </div>
                <div class="col-md-auto pb-2 pt-2"><a href="#" class="text-white"><?php _e( 'Privacy Policy', 'aussie_audio_theme' ); ?></a> | <a href="#" class="text-white"><?php _e( 'Terms of Use', 'aussie_audio_theme' ); ?></a>
                </div>
            </div>                     
        </div>                 
    </div>             
